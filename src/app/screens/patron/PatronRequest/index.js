...
import { mockedShippingOptions, itemRequests } from './mocks';
import './styles.css';
  ...
  return (
    <div className="h-screen">
      <BlueHeader roundedClass="rounded-b-none" onClickLeft={history.goBack}>
        <LocationBlueBlock title="CAIRO, EGYPT" className="pt-1 pb-5">
          <input
          ...
          <div className="px-3 pt-8 pb-36">
            ...
            <div className="mb-6">
              ...
              <RoundedCard paddingVertical="py-5">
                ...
                <div className="flex py-4 border-b mb-4">
                  <CheckWithLabel
                    className="flex-3"
                    label="Shipping"
