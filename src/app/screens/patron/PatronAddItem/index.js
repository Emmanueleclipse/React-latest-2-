...
const PatronAddItem = () => {
  ...
  const onClickSaveItem = () => {
    // TODO: Process a request to save the item in API server and local memory
    history.goBack();
  };
          ...
          <div className="mb-8">
            ...
            <div className="flex justify-between mt-3 mb-2">
              <p className="font-gotham-bold text-blue-gray">
                {formInfo.weightRange.min / 1000} {unitOption.unit} -{' '}
                {formInfo.weightRange.max / 1000} {unitOption.unit}
              </p>
              <Dropdown
