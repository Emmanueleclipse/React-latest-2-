    ...
    <>
      <div className="w-68 bg-blue-gray p-7">
        <div className="flex items-center mb-10">
          <img className="w-11 rounded-full" src={userInfo.photoUrl} alt="" />
          <div className="ml-4 opacity-95">
            <p className="font-gotham-bold text-white text-sm">
              {userInfo.name}
            </p>
            <p className="font-gotham-medium text-white text-2xs">
              {userInfo.location}
            </p>
          </div>
        </div>
